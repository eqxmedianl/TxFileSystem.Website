...
Since no library existed that fullfilled this need, the company owner decide to develop one for the public. It is since it's first release published on NuGet.

## Design and Development

### Company
The development of this OpenSource .NET library `TxFileSytem` is facilitated by [EQX Media B.V.](https://www.eqx-media.nl "Visit the website of EQX Media B.V."), a company *Software Development House & Marketing Agency* from The Netherlands.
